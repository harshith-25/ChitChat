	...
	return (
		<div className="mt-5 flex flex-col items-center">
			{contacts.map((contact) => (
				<div
					className={`px-10 py-2 transition-all duration-300 rounded-full cursor-pointer ${selectedChatData && selectedChatData._id === contact._id ? "bg-[#8427ff] hover:bg-[#8417ff]" : "hover:bg-[#f1f1f111]"}`}
					key={contact._id}
